...
int sys_net_get_hw_addr(void *buf, size_t len);
int sys_net_tx_pkt(const void *pkt_buf, size_t pkt_len);
int sys_net_rx_pkt(void *pkt_buf, size_t pkt_len);
